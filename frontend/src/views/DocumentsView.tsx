          ...
          <div className="field">
            ...
            <div className="row">
              ...
              <button className="primary" onClick={upload} disabled={busy !== null}>
                {busy === "upload" ? "Ingesting…" : "Upload"}
              </button>
            </div>
          </div>
          <div className="field">
            <label htmlFor="website-url">Index a website</label>
            <div className="row">
              <input
                id="website-url"
                className="grow"
              ...
              <button className="primary" onClick={crawl} disabled={busy !== null}>
                {busy === "url" ? "Crawling…" : "Index"}
              </button>
            </div>
          </div>
          <div className="field">
            <label htmlFor="repository-url">Index a Git repository</label>
            <div className="row">
              <input
                id="repository-url"
                className="grow"
